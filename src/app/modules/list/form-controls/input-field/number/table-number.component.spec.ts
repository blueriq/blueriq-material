...
import { TableNumberFieldComponent } from './table-number.component';

describe('TableNumberFieldComponent', () => {
  ...
  beforeEach(() => {
    const fieldNumber = FieldTemplate.number()
  ...
  it('should extend from TableInputFieldComponent', () => {
    expect((TableNumberFieldComponent.prototype instanceof TableInputFieldComponent)).toBeTruthy();
  });

  it('should contain error and messages within a tooltip', () => {
    const matFormField = component.debugElement.query(By.css('bq-table-integer-field mat-form-field'));
